...
public class DepartmentController {
    ...
    public String  deleteDepartment(@PathVariable int id) {
        ...
        //@PathVariable->to get the value of url parameter
    ...
    //}
      ...
      //custom JPL query
        ...
        public Department getAllDepartmentByName(@PathVariable String name){
        	return departmentRepository.findByNamedUsingJPQL(name);
        }
        
        //custom SQL native Query
        @GetMapping(value = "/pattern/{pattern}")
        public List<Department> getAllDepartmentPattern1(@PathVariable String pattern){
